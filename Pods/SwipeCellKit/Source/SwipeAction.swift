...
public class SwipeAction: NSObject {
    ...
    @objc public var handler: ((SwipeAction, IndexPath) -> Void)?
    ...
    @objc public var backgroundEffect: UIVisualEffect?
    ...
    @objc public var hidesWhenSelected = false
...
internal extension SwipeAction {
    @objc var hasBackgroundColor: Bool {
